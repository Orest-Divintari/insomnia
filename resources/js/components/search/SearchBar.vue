  ...
  <div>
    <dropdown :styleClasses="'w-80'">
      <template v-slot:dropdown-trigger>
        <a class="fas fa-search text-blue-dark cursor-pointer hover:text-blue-mid"></a>
      </template>
          ...
          <div class="bg-blue-lighter py-3">
            <div class="px-2">
              ...
              <div class="flex flex-row-reverse mt-4 justify-end pl-1">
                <label class="text-xs text-black-semi ml-2" for="only_title">Search titles only</label>
                <input
                  @click="requestTitle"
                  type="checkbox"
                  ref="onlyTitle"
            ...
            <div class="flex justify-end mt-2 pr-2 text-xs items-center">
              <button type="submit" class="form-button-small mr-2">
