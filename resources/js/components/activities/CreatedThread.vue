<template>
  <div>
    <a class="blue-link text-md" @click="showThread(activity.subject)">{{ activity.subject.title }}</a>
    ...
    <div class="flex text-xs text-gray-lightest items-center">
      ...
      <div class>
        thread by
        <a
          @click="showProfile(activity.subject.poster)"
          class="blue-link"
        >{{ activity.subject.poster.name }}</a>
      </div>
      <p class="dot"></p>
      <a
        @click="showCategory(activity.subject.category)"
        class="blue-link"
      >{{ activity.subject.category.title }}</a>
    </div>
  </div>
</template>
